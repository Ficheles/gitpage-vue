      ...
      <div class="col-sm-12 col-lg-6">
        <div class="card-hover-shadow-2x mb-3 card">
          ...
          <div class="scroll-area-lg">
            <VuePerfectScrollbar v-once class="scrollbar-container">
              <div class="p-4">
                <div
...
import { faTrashAlt, faCheck, faCalendarAlt, faAngleDown, faAngleUp, faTh } from '@fortawesome/free-solid-svg-icons'
