            ...
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <b-form-group id="exampleInputGroup2" label-for="exampleInput2">
                      <b-form-input id="exampleInput2" type="password" required placeholder="Repeat password...">
                      </b-form-input>
                    </b-form-group>
                  </div>
                </div>
              ...
              <div class="modal-footer d-block text-center">
                <b-button color="primary" class="btn-wide btn-pill btn-shadow btn-hover-shine" size="lg"
                  >Create Account
                </b-button>
              </div>
            </div>
